...
def create_block1(bg,tmr):
    global flag,ran1,ran2,ran3,ran4,ran5,ran6,ran7,ran8,posp3,posn3,copy_posp1,copy_posp2,copy_posp3,copy_posn3,ranlis,poslis,sabun,waittmr,stopflag
    if flag == 0:
        bg.fill(BLACK)
        ...
        if copy_posp2[1] + t >= 154 + 54 * 7:
            copy_posp1[1] = 154 + 54 * 7
            copy_posp2[1] = 154 + 54 * 7
            copy_posp3[1] = 154 + 54 * 7 - sabun[1]
...
def move_block(key,tmr):
    ...
    if copy_posp3[0] == 26 + 54 * 7:
        s1 = 0
    if copy_posp1[0] == 26 + 54 * 0:
        s2 = 0
